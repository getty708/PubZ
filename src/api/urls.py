from api import views_autocomplete, views_rest
...
urlpatterns = [
    ...
    path(
        "autocomplete/author/",
        views_autocomplete.AutocompleteAuthor.as_view(),
        name="autocomplete_author",
    ),
    path(
        "autocomplete/book/",
        views_autocomplete.AutocompleteBook.as_view(),
        name="autocomplete_book",
    ),
    # REST API
