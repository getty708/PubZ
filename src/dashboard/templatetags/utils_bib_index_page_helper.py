...
def print_bibtexs(context, style=False,):
    ...
    At first. this function load a template of the selected display style (e.g. list, tile).
    Then render and return the html object.

    Args:
        context (context): django cotnext object.
        style (str, optional): keyword of a display style (e.g. list, tile, bibtex). (default: False)
