from core import views, views_edit
...
urlpatterns = [
    ...
    # email alert
    # path(
    #     'notification/alert/<str:author_id>/<int:bibtex_id>',
    #     views.notification_alert_author, name='alert_by_author',
    # ),
    ...
    path("author/order/add", views_edit.author_order_edit, name="author_order_add"),
    path(
        "author/order/edit/<int:author_order_id>/",
        views_edit.author_order_edit,
        name="author_order_edit",
    ),
    path("tag/add", views_edit.tag_edit, name="tag_add"),
    path("tag/edit/<int:tag_id>/", views_edit.tag_edit, name="tag_edit"),
    path("tag/tagchain/add", views_edit.tagchain_edit, name="tagchain_add"),
    path(
        "tag/tagchain/edit/<int:tagchain_id>/",
        views_edit.tagchain_edit,
        name="tagchain_edit",
    ),
]
