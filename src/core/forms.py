...
class BookForm(forms.ModelForm):
    ...
    def clean_title(self):
        ...
        Note:
            ...
            * To ``Transactions on`` : Trans. on, trans. on, Trans., trans., Transaction
                 on, transaction on
            * To ``Proceedings of`` : in Proceeding of, in proceeding of, in Proc. of,
                in proc. of, Proc. of, proc. of, Proc., proc.,
