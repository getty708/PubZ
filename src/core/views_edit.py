...
def bibtex_edit(request, bibtex_id=None):
    ...
    if bibtex_id:
        ...
        submit_url = reverse("core:bibtex_edit",
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            bibtex_new.save()
            return redirect('core:bib_detail', pk=bibtex.id,)
        else:
...
def bibtex_edit_step1(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            bibtex.save()
            print("Saved", bibtex)
            return redirect('core:bibtex_edit', bibtex_id=bibtex.id,)
        else:
            print("validation fail")
    else:
...
def author_order_edit(request, author_order_id=None):
    ...
    if author_order_id:
        ...
        submit_url = reverse("core:author_order_edit",
...
def tag_edit(request, tag_id=None):
    ...
    if tag_id:
        ...
        submit_url = reverse("core:tag_edit",
...
def tagchain_edit(request, tagchain_id=None):
    ...
    if tagchain_id:
        ...
        submit_url = reverse("core:tagchain_edit",
